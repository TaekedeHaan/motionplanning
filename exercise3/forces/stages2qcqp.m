% Convert a FORCES Pro stages structure to QCQP input data format.
% 
%    [H,f,Aineq,bineq,Aeq,beq,l,Q,r,lb,ub] = STAGES2QCQP(STAGES,PARAMS,PROBLEM) converts
%    the structure STAGES into a QCQP description for the quadratically 
%    constrained problem
%
