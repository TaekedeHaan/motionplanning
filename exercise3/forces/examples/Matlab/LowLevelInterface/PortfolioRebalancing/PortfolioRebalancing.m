% FORCES Portfolio rebalancing optimization example.
%
...
%
% 2) Cost function: FORCES supports the quadratic cost 0.5*z'*H*z + f'z, so
...
%
% (c) embotech AG, Zurich, Switzerland, 2013-2016. All rights reserved.
...
for i = 1:number_of_problems
    ...
    %% run FORCES generated solver!
    % set up FORCES problem - fill in parameters
