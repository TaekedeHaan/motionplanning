...
#      define CASADI_LRDLESOLVER_FIXED_SMITH_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define CASADI_LRDLESOLVER_FIXED_SMITH_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define CASADI_LRDLESOLVER_FIXED_SMITH_DEPRECATED 
#endif
